        ...
        <div class="container">
            <ul class="suggest-slider slider-arrow">
                @forelse ($kategori as $isi)
                    <li>
                        <a class="suggest-card" href="/kategori/{{ $isi->id }}">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="home-category-slider slider-arrow slider-dots">
                        <a href="#"><img src="img/banner/Banner1.png" alt="banner"></a>
                        <a href="#"><img src="img/banner/Banner2.png" alt="banner"></a>
                        <a href="#"><img src="img/banner/Banner3.png" alt="banner"></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-heading">
                        <h2>Produk Terlaris Dan Terbaru</h2>
                    </div>
                </div>
            </div>
    ...
    <div class="section promo-part">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="promo-img">
                        <a href=""><img src="new template/images/promo/home/5740583.jpg" alt="promo"></a>
                    </div>
                </div>
            </div>
        </div>
