                    ...
                    <div class="row mb-50 mt-30">
                            ...
                            <div class="detail-gallery">
                                ...
                                <div class="product-image-slider">
                                    {{-- <figure class="border-radius-10">
                                        <img src="img/produk/{{$produk->foto}}" alt="product image" />
                                    </figure> --}}
                                    {{-- <figure class="border-radius-10">
                                        <img src="img/produk/{{ $produk->foto }}" alt="product image" />
                                    </figure> --}}
                                ...
                                <div class="slider-nav-thumbnails">
                                    {{-- <div><img src="img/produk/{{$produk->foto}}" alt="product image" /></div> --}}
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="detail-info pr-30 pl-30">
                                ...
                                <h2 class="title-detail">{{ $produk->nama_kue }}</h2>
                                ...
                                <div class="clearfix product-price-cover">
                                    <div class="product-price primary-color float-left">
                                        <span class="current-price text-brand">Rp. {{ number_format( $produk->harga,0,",",".") }}</span>
                                        {{-- <span>
                                ...
                                <div class="short-desc mb-30">
                                    <p class="font-lg">{{ $produk->keterangan }}</p>
                                </div>
                                ...
                                <div class="font-xs">
                                    ...
                                    <ul class="float-start">
                                        ...
                                        <li class="mb-5">Kategori: <a href="#" rel="tag">{{ $produk->kategoris->kategori }}</a></li>
                                        <li>Stock:<span class="in-stock text-brand ml-5">{{ $produk->stock }} Stock</span></li>
                                    </ul>
                                </div>
                            </div>
                            <!-- Detail Info -->
