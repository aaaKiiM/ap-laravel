            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="details-gallery">
                        ...
                        <ul class="details-preview">
                            <li><img src="{{ asset('produk/'.$produk->foto) }}" alt="product"></li>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="details-content">
                        <h3 class="details-name"><a href="#">{{ $produk->nama_kue }}</a></h3>
                        <div class="details-meta">
                            <p>Stock :<span>{{ $produk->stock}}</span></p>
                            <p>Toko :<a href="#">{{ $produk->toko->nama_toko}}</a></p>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <ul class="nav nav-tabs">
                        ...
                        <li><a href="#tab-spec" class="tab-link" data-bs-toggle="tab">Detail Lengkap</a></li>
