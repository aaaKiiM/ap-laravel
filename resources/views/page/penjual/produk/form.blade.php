...
<section class="content-main">
    <form class="row" action="/produk/store" method="post" enctype="multipart/form-data">
        @csrf
        <div class="col-12">
            <div class="content-header">
                ...
                <div>
                    <button type="submit" class="btn btn-md rounded font-sm hover-up">Tambah</button>
                </div>
            </div>
        </div>
        <div class="col-lg-9">
            <div class="card mb-4">
                <div class="card-body">
                    <div class="mb-4">
                        ...
                        <input type="text" name="nmProduk" placeholder="Masukkan Nama Produk" class="form-control">
                    </div>
                    <div class="row gx-3">
                        <div class="col-md-6 mb-3">
                            <label for="product_sku" class="form-label">Harga</label>
                            <input type="text" id="rupiah" name="harga" placeholder="Rp.-" class="form-control">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="product_color" class="form-label">Stock</label>
                            <input type="number" name="stock" placeholder="Masukkan Stock" class="form-control">
                        </div>
                    </div>
            ...
            <div class="card mb-4">
                <div class="card-body">
                    <div>
                        ...
                        <textarea placeholder="Keterangan" name="ket" class="form-control" rows="4"></textarea>
                    </div>
                </div>
            </div>
            <!-- card end// -->
            ...
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="kat" value="Bolu" id="product-cat" />
                        <label class="form-check-label" for="product-cat"> Bolu </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="kat" value="Brownies" id="product-cat-1" />
