...
<html lang="en">
    <head>
        ...
        <!-- Favicon -->
        <link rel="shortcut icon" type="image/x-icon" href="{{ asset('pembeli-template/imgs/theme/favicon.svg') }}" />

        <!-- Template CSS -->
        <link rel="stylesheet" href="{{ asset('pembeli-template/css/plugins/animate.min.css') }}" />
        <link rel="stylesheet" href="{{ asset('pembeli-template/css/main.css?v=4.0') }}" />
    </head>
    ...
    <body>
                ...
                <div class="container">
                    <div class="header-wrap">
                        <div class="logo logo-width-1">
                            <a href="index.html"><img src="{{ asset('pembeli-template/imgs/theme/logo.svg') }}" alt="logo" /></a>
                        </div>
                                ...
                                <div class="header-action-2">
                                    ...
                                    <div class="header-action-icon-2">
                                        <a class="mini-cart-icon" href="/checkout">
                                            <img alt="Nest" src="{{ asset('pembeli-template/imgs/theme/icons/icon-cart.svg') }}" />
                                            @guest
                                        ...
                                        <a href="/checkout"><span class="lable">Cart</span></a>
                                        {{-- <div class="cart-dropdown-wrap cart-dropdown-hm2">
                                            <ul>
                                                <li>
                                                    <div class="shopping-cart-img">
                                                        <a href="shop-product-right.html"><img alt="Nest" src="{{ asset('pembeli-template/imgs/shop/thumbnail-3.jpg') }}" /></a>
                                                    </div>
                                                ...
                                                <li>
                                                    <div class="shopping-cart-img">
                                                        <a href="shop-product-right.html"><img alt="Nest" src="{{ asset('pembeli-template/imgs/shop/thumbnail-2.jpg') }}" /></a>
                                                    </div>
                                                    <div class="shopping-cart-title">
                                    ...
                                    <div class="header-action-icon-2">
                                        <a href="page-account.html">
                                            <img class="svgInject" alt="Nest" src="{{ asset('pembeli-template/imgs/theme/icons/icon-user.svg') }}" />
                                        </a>
                    ...
                    {{-- <div class="header-wrap header-space-between position-relative">
                        ...
                        {{-- <div class="header-action-right d-block d-lg-none">
                            <div class="header-action-2">
                                <div class="header-action-icon-2">
                                    <a href="#">
                                        <img alt="Nest" src="{{ asset('pembeli-template/imgs/theme/icons/icon-user.svg') }}" />
                                    </a>
                                </div>
                                <div class="header-action-icon-2">
        ...
        <!-- Vendor JS-->
        <script src="{{ asset('pembeli-template/js/vendor/modernizr-3.6.0.min.js') }}"></script>
        <script src="{{ asset('pembeli-template/js/vendor/jquery-3.6.0.min.js') }}"></script>
        <script src="{{ asset('pembeli-template/js/vendor/jquery-migrate-3.3.0.min.js') }}"></script>
        <script src="{{ asset('pembeli-template/js/vendor/bootstrap.bundle.min.js') }}"></script>
        <script src="{{ asset('pembeli-template/js/plugins/slick.js') }}"></script>
        <script src="{{ asset('pembeli-template/js/plugins/jquery.syotimer.min.js') }}"></script>
        <script src="{{ asset('pembeli-template/js/plugins/waypoints.js') }}"></script>
        <script src="{{ asset('pembeli-template/js/plugins/wow.js') }}"></script>
        <script src="{{ asset('pembeli-template/js/plugins/perfect-scrollbar.js') }}"></script>
        <script src="{{ asset('pembeli-template/js/plugins/magnific-popup.js') }}"></script>
        <script src="{{ asset('pembeli-template/js/plugins/select2.min.js') }}"></script>
        <script src="{{ asset('pembeli-template/js/plugins/counterup.js') }}"></script>
        <script src="{{ asset('pembeli-template/js/plugins/jquery.countdown.min.js') }}"></script>
        <script src="{{ asset('pembeli-template/js/plugins/images-loaded.js') }}"></script>
        <script src="{{ asset('pembeli-template/js/plugins/isotope.js') }}"></script>
        <script src="{{ asset('pembeli-template/js/plugins/scrollup.js') }}"></script>
        <script src="{{ asset('pembeli-template/js/plugins/jquery.vticker-min.js') }}"></script>
        <script src="{{ asset('pembeli-template/js/plugins/jquery.theia.sticky.js') }}"></script>
        <script src="{{ asset('pembeli-template/js/plugins/jquery.elevatezoom.js') }}"></script>
        <!-- Template  JS -->
        <script src="{{ asset('pembeli-template/js/main.js?v=4.0') }}"></script>
        <script src="{{ asset('pembeli-template/js/shop.js?v=4.0') }}"></script>

        <script type="text/javascript">

            var rupiah = document.getElementById('rupiah');
            rupiah.addEventListener('load', function(e){
